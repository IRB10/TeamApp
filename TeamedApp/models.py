...
class AuthUser(models.Model):
    ...
    termini = models.ManyToManyField('Termini')
...
class Destinacije(models.Model):
    ...
    def __unicode__(self):
        return str(self.destinacija_naziv)
...
class Termini(models.Model):
    ...
    termin_kreiran = models.DateTimeField(auto_now=True)
    vrijeme_termina = models.DateTimeField()
...
class KorisnikTermin(models.Model):
    id = models.AutoField(primary_key=True)
    id_korisnik = models.ForeignKey(AuthUser)
    id_termin = models.ForeignKey('Termini')

    class Meta:
        managed = False
        db_table = 'korisnik_termin'
        unique_together = (('id_korisnik', 'id_termin'),)
